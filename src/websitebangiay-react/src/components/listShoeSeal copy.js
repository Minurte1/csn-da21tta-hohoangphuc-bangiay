...
import { ShoeListSealNam } from '../components/childComponent/childListSeal copy'
...
function ListShoeSealNam() {
    ...
    return (
        <div className="App">
            <ShoeListSealNam shoes={data} />
        </div>
    );
}

export default ListShoeSealNam;